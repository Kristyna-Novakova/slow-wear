      ...
      <div className="image-container">
        <div className="image">
          ...
          <p className="image-caption">
            Čtyři topy a stejné šaty ve dvou velikostech? Šest párů džín? Jeden
            kus od všeho? Je to na tobě.
          </p>
        </div>
        <div className="image">
          ...
          <p className="image-caption">
            Celý další měsíc jsou vybrané kousky jen tvoje. O praní a opravy se
            nemusíš starat.
          </p>
        </div>
        <div className="image">
